...
public class A33_MarkitEconomics_IHSMarkit_BME_GER extends MarkitEconomicsDOMParser {

    public A33_MarkitEconomics_IHSMarkit_BME_GER(ThreadRunnerTaskEventsDispacher disp, SaveRequestFilterHandler<Double> valueFilter) {
    ...
    protected String onEventNameLoad() {
        return "IHS Markit / BME Germany Manufacturing PMI";
    }
}
